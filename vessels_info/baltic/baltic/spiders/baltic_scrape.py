...
class BalticScrapeSpider(scrapy.Spider):
    name = 'baltic_scrape'
    # start_urls = ['http://www.balticshipping.com']
    sturls = [str("https://www.balticshipping.com/vessel/imo/"+l.strip()) for l in open('D:/PSC_Tokyo_refinie/Scrapy/baltic/rest_IMO.csv').readlines()]
